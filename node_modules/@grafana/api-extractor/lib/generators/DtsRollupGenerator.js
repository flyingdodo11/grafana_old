    ...
    static _generateTypingsFileContent(collector, stringWriter, dtsKind) {
        ...
        for (const entity of collector.entities) {
            ...
            if (astEntity instanceof AstNamespaceImport_1.AstNamespaceImport) {
                const astModuleExportInfo = collector.astSymbolTable.fetchAstModuleExportInfo(astEntity.astModule);
            ...
            case ts.SyntaxKind.ImportType:
                {
                    ...
                    if (referencedEntity) {
                        ...
                        if (referencedEntity.astEntity instanceof AstImport_1.AstImport &&
                            ...
                            const replacement = referencedEntity.astEntity.exportName
